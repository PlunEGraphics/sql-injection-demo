...
-->
  <body>
    <h1 align="center">
      Normal vulnerable form
    </h1><br>
    <form name="cont" method="post" action="normprocess.php" id="cont">
      <center>
        <table>
          <tr>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input id="pass" type="text" required placeholder="Password" name="pass" maxlength="20" size " 15 "><br/><br/>
            </td>
          </tr>
          <tr>
            <td></td>
